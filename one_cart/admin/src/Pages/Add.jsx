...
import upload from "../assets/update.png";
...
const Add = () => {
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${serveUrl}/api/product/addproduct`,
        formData,
        {
  ...
  return (
    <div className="w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white overflow-x-hidden relative pb-10">
      <Nav />
      <Sidebar />

      <div className="w-[80%] flex items-center justify-start overflow-x-hidden absolute right-0">
        <form
          action=""
          className="w-[100%] md:w-[90%]  smh-[100%] mt-[70px] flex flex-col gap-[30px] py-[60px] px-[15px] md:px-[60px]"
          onSubmit={handleAddProduct}
        >
          <div className="w-[400px] h-[50px] text-[25px] md:text-[40px] text-white">
            Add Product Page
          </div>
          <div className="w-[78%] sm:w-[90%] h-[130px] flex items-start justify-center flex-col mt-[20px] gap-[10px]">
          ...
          <div className="w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px]">
            ...
            <input
              ...
              className="w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 placeholder:text-[#ffffffc2] pl-2"
          ...
          <div className="w-[80%] flex items-start justify-center flex-col gap-[10px]">
            ...
            <textarea
              type="text"
              placeholder="Type here"
              className="w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 placeholder:text-[#ffffffc2] pl-2 py-2"
          ...
          <div className="w-[80%] flex items-center gap-[10px] flex-wrap">
            <div className="md:w-[40%] w-[100%] flex flex-col items-start gap-[10px]">
              <p className="text-[20px] md:text-[25px] font-semibold whitespace-nowrap">
                Product Category
              </p>
              <select
                className="bg-slate-600 md:w-auto w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px]"
