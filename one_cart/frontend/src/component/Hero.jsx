...
const Hero = ({ heroData, heroCount, setHeroCount }) => {
   const currentData = heroData[heroCount];
  return (
    <div className="w-[40%] h-[100%] relative">
      <div className="absolute text-[#88d9ee] text-[25px] md:text-[40px] lg:text-[55px] md:left-[10%] md:top-[90px] lg:top-[130px] left-[10%] top-[10px]">
        <p>{currentData?.text1}</p>
        <p>{currentData?.text2}</p>
      </div>
      <div className="absolute md:top-[400px] lg:top-[500px] top-[280px] left-[10%] flex items-center justify-center gap-[10px]">
        <FaCircle
          className={`w-[14px] ${
